...
void ImGui::ShowDemoWindow(bool *p_open) {
    ...
    if (ImGui::CollapsingHeader("Widgets")) {
        ...
        if (ImGui::TreeNode("Data Types")) {
            ...
            ImGui::DragScalar("drag double", ImGuiDataType_Double, &f64_v, 0.0005f, &f64_zero, NULL, "%.10f grams",
                              1.0f);
            ImGui::DragScalar("drag double ^2", ImGuiDataType_Double, &f64_v, 0.0005f, &f64_zero, &f64_one,
                              "0 < %.10f < 1", 2.0f);
    ...
    if (ImGui::CollapsingHeader("Inputs, Navigation & Focus")) {
        ...
        ImGui::CheckboxFlags("io.ConfigFlags: NavEnableGamepad [beta]", (unsigned int *) &io.ConfigFlags,
                             ImGuiConfigFlags_NavEnableGamepad);
        ImGui::CheckboxFlags("io.ConfigFlags: NavEnableKeyboard [beta]", (unsigned int *) &io.ConfigFlags,
