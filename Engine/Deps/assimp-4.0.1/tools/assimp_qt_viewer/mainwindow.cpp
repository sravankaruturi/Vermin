...
void MainWindow::ImportFile(const QString &pFileName) {
    ...
    // Try to import scene.
    mScene = mImporter.ReadFile(pFileName.toStdString(),
    ...
    if (mScene != nullptr) {
        ...
        ui->cbxBBox->setChecked(false);
        mGLView->Enable_SceneBBox(false);
...
MainWindow::MainWindow(QWidget *parent)
    ...
    DefaultLogger::get()->attachStream(mLoggerView,
                                       DefaultLogger::Debugging | DefaultLogger::Info | DefaultLogger::Err |
                                       DefaultLogger::Warn);
}
...
MainWindow::~MainWindow() {
    ...
    DefaultLogger::get()->detatchStream(mLoggerView,
                                        DefaultLogger::Debugging | DefaultLogger::Info | DefaultLogger::Err |
                                        DefaultLogger::Warn);
    DefaultLogger::kill();
