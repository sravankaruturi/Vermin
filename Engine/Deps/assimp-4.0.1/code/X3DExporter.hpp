...
///
    ...
    private:
        ...
        /// \param [out] pTargetString - reference to string where result will be placed. Will be cleared before using.
        void
        AttrHelper_Vec3DArrToString(const aiVector3D *pArray, const size_t pArray_Size, std::string &pTargetString);
        ...
        void
        AttrHelper_Vec2DArrToString(const aiVector2D *pArray, const size_t pArray_Size, std::string &pTargetString);
        ...
        void AttrHelper_Vec3DAsVec2fArrToString(const aiVector3D *pArray, const size_t pArray_Size,
        ...
        void AttrHelper_FloatToAttrList(std::list<SAttribute> &pList, const std::string &pName, const float pValue,
        ...
        void
        AttrHelper_Color3ToAttrList(std::list<SAttribute> &pList, const std::string &pName, const aiColor3D &pValue,
                                    const aiColor3D &pDefaultValue);
        ...
        void NodeHelper_OpenNode(const std::string &pNodeName, const size_t pTabLevel, const bool pEmptyElement,
                                 const std::list<SAttribute> &pAttrList);
        ...
        void
        NodeHelper_OpenNode(const std::string &pNodeName, const size_t pTabLevel, const bool pEmptyElement = false);
    ...
    public:
        ...
        /// \fn X3DExporter()
        /// Default constructor.
        X3DExporter(const char *pFileName, IOSystem *pIOSystem, const aiScene *pScene,
