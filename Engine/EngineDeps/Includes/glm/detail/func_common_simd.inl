...
namespace glm {
    namespace detail {
        ...
        struct compute_clamp_vector<4, float, Q, true> {
            ...
            call(vec<4, float, Q> const &x, vec<4, float, Q> const &minVal, vec<4, float, Q> const &maxVal) {
                vec<4, float, Q> result;
        ...
        struct compute_clamp_vector<4, int32, Q, true> {
            GLM_FUNC_QUALIFIER static vec<4, int32, Q>
            call(vec<4, int32, Q> const &x, vec<4, int32, Q> const &minVal, vec<4, int32, Q> const &maxVal) {
                vec<4, int32, Q> result;
        ...
        struct compute_clamp_vector<4, uint32, Q, true> {
            GLM_FUNC_QUALIFIER static vec<4, uint32, Q>
            call(vec<4, uint32, Q> const &x, vec<4, uint32, Q> const &minVal, vec<4, uint32, Q> const &maxVal) {
                vec<4, uint32, Q> result;
        ...
        struct compute_mix_vector<4, float, bool, Q, true> {
            GLM_FUNC_QUALIFIER static vec<4, float, Q>
            call(vec<4, float, Q> const &x, vec<4, float, Q> const &y, vec<4, bool, Q> const &a) {
...
*/
        ...
        struct compute_smoothstep_vector<4, float, Q, true> {
            GLM_FUNC_QUALIFIER static vec<4, float, Q>
            call(vec<4, float, Q> const &edge0, vec<4, float, Q> const &edge1, vec<4, float, Q> const &x) {
                vec<4, float, Q> Result;
