...
#	endif//!GLM_HAS_DEFAULTED_FUNCTIONS
    ...
    template<typename T, qualifier Q>
    GLM_FUNC_QUALIFIER mat<2, 2, T, Q> operator+(mat < 2, 2, T, Q >
    const& m) {
    return
    m;
}
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER mat<3, 2, T, Q> operator*(mat < 2, 2, T, Q >
const& m1,
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER mat<4, 2, T, Q> operator*(mat < 2, 2, T, Q >
const& m1,
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER typename mat<2, 2, T, Q>::col_type operator/(mat < 2, 2, T, Q >
const& m,
typename mat<2, 2, T, Q>::row_type const &v
)
{
...
template<typename T, qualifier Q>
GLM_FUNC_QUALIFIER bool operator==(mat < 2, 2, T, Q >
const& m1,
mat<2, 2, T, Q> const &m2
)
{
