...
namespace vermin {
    ...
    bool BoundingBox::CheckForCollisionWithRay(const glm::mat4 _modelMatrix, const glm::vec3 _scale,
                                               const glm::vec3 _rayOrigin, const glm::vec3 _rayDirection,
                                               float &_intersectionDistance) const {
        ...
        const auto scaled_min = glm::vec3(_scale.x * minimumPoint.x, _scale.y * minimumPoint.y,
                                          _scale.z * minimumPoint.z);
        const auto scaled_max = glm::vec3(_scale.x * maximumPoint.x, _scale.y * maximumPoint.y,
                                          _scale.z * maximumPoint.z);
        ...
        {
            const glm::vec3 obb_xaxis = glm::normalize(
                    glm::vec3(_modelMatrix[0].x, _modelMatrix[0].y, _modelMatrix[0].z));
        ...
        {
            const glm::vec3 obb_yaxis = glm::normalize(
                    glm::vec3(_modelMatrix[1].x, _modelMatrix[1].y, _modelMatrix[1].z));
        ...
        {
            const glm::vec3 obb_zaxis = glm::normalize(
                    glm::vec3(_modelMatrix[2].x, _modelMatrix[2].y, _modelMatrix[2].z));
